...
@interface SucceedOrderViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation SucceedOrderViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section >0 && indexPath.section <5) {
        ctl.stateIndex =indexPath.section;
    ...
    ctl.typeIndex = indexPath.section /2 + 1;
