...
#define kAlertMessage3(aMessage) dispatch_async(dispatch_get_main_queue(), ^{\
UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"拨打" message:aMessage delegate:self cancelButtonTitle:@"确定" otherButtonTitles:@"取消", nil];\
[alert show];\
});
...
#define MCimageViewToBounds(imageView)\
\
